...
exp_ficus0="--exp_name NSVF_FICUS_PAMA_DEPTH_GUIDE_$style_idx"
...
exp_hotdog0="--exp_name NSVF_HOTDOG_PAMA_DEPTH_GUIDE_$style_idx"
python train.py --config config/nerf_st/nsvf_hotdog.yml --loop 0 $use_filter $style $exp_hotdog0
python train.py --config config/nerf_st/nsvf_hotdog.yml --loop 1 $use_filter $style $exp_hotdog0
python train.py --config config/nerf_st/nsvf_hotdog.yml --loop 2 $use_filter $style $exp_hotdog0
python train.py --config config/nerf_st/nsvf_hotdog.yml --loop 3 $use_filter $style $exp_hotdog0

exp_mic0="--exp_name NSVF_MIC_PAMA_DEPTH_GUIDE_$style_idx"
python train.py --config config/nerf_st/nsvf_mic.yml --loop 0 $use_filter $style $exp_mic0
python train.py --config config/nerf_st/nsvf_mic.yml --loop 1 $use_filter $style $exp_mic0
python train.py --config config/nerf_st/nsvf_mic.yml --loop 2 $use_filter $style $exp_mic0
python train.py --config config/nerf_st/nsvf_mic.yml --loop 3 $use_filter $style $exp_mic0

exp_ship0="--exp_name NSVF_SHIP_PAMA_DEPTH_GUIDE_$style_idx"
